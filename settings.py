...
DIR_DATASET = 'DATASET/'
DIR_DATASET_FASTTEXT = DIR_DATASET + 'FASTTEXT/'
DIR_REPORT = 'REPORT/'
DIR_EDA = 'EDA/'
...
DIR_PERFORMENCE_REPORT_FLAIR = DIR_PERFORMENCE_REPORT + 'FLAIR/'
DIR_PERFORMENCE_REPORT_FASTTEXT = DIR_PERFORMENCE_REPORT + 'FASTTEXT/'
DIR_RESOURCES = 'resources/'
DIR_MODEL_FLAIR = DIR_RESOURCES + 'FLAIR/'
DIR_MODEL_FASTTEXT = DIR_RESOURCES + 'FASTTEXT/'
for i in [DIR_DATASET, DIR_REPORT, DIR_EDA, DIR_IMAGES_EDA, DIR_IMAGES_HISTORY, DIR_PERFORMENCE_REPORT,
          DIR_PERFORMENCE_REPORT_PYTORCH, DIR_PERFORMENCE_REPORT_FLAIR, DIR_RESOURCES, DIR_MODEL_FLAIR,
          DIR_MODEL_FASTTEXT, DIR_DATASET_FASTTEXT, DIR_PERFORMENCE_REPORT_FASTTEXT]:
